          ...
          {navigations.map((navigation, index) => (
            <li key={index} className="relative group">
              <Link
                ...
                className={`py-[0.375rem] flex gap-3 items-center px-[0.9375rem] duration-300 ${
              ...
              <span className="absolute top-1/2 -translate-y-1/2 text-xs bg-[#131720] px-3 py-2 rounded-md left-[4.375rem] z-50 hidden group-hover:block duration-300 min-[1230px]:group-hover:hidden">
